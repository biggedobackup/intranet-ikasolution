...
var App = function (_a) {
    ...
    return (React.createElement("div", { ref: rootRef, className: "min-h-screen flex flex-col bg-slate-100 text-ikaInk antialiased" },
        ...
        page === 'accueil' && React.createElement(Accueil_1.Accueil, null),
        page === 'detail-evenement' && React.createElement(detail_evenement_1.DetailEvenement, null),
        page === 'tous-evenements' && React.createElement(tous_evenements_1.TousEvenements, null),
        page === 'detail-actualite' && React.createElement(detail_actualite_1.DetailActualite, null),
        page === 'toutes-actualites' && React.createElement(toutes_les_actualites_1.ToutesActualites, null),
        page === 'detail-agenda' && React.createElement(detail_agenda_1.DetailAgenda, null),
        page === 'toutes-agenda' && React.createElement(toutes_agenda_1.ToutesAgenda, null),
