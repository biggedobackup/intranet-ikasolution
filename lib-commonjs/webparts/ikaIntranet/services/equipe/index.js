...
exports.fetchAadUsers = fetchAadUsers;
exports.importMembresFromAad = importMembresFromAad;
...
function loadMembres(siteUrl, force) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
...
function fetchAadUsers(graphClient) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
...
function importMembresFromAad(siteUrl, graphClient) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, (0, index_1.updateListItemFields)(siteUrl, listName, match.id, fields)];
                case 6:
                    ok = _d.sent();
                    if (ok)
                        result.updated += 1;
                ...
                case 7:
                    fields = (_c = {},
                        ...
                        _c[activeKey] = true,
                        _c);
                    return [4 /*yield*/, (0, index_1.createListItem)(siteUrl, listName, fields)];
                case 8:
                    id = _d.sent();
                    if (id)
                        result.created += 1;
