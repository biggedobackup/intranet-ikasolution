...
exports.loadAnnonces = loadAnnonces;
exports.updateAnnonceLikedBy = updateAnnonceLikedBy;
exports.updateAnnonceComments = updateAnnonceComments;
                ...
                case 4:
                    ...
                    annonces_1 = items
                        ...
                        return {
                            ...
                            badge: badgeFor(type),
                            likedBy: (0, index_1.parseLikedBy)(getVal(it, fieldMap_1, 'AimePar', ['AimePar'])),
                            comments: (0, index_1.parseComments)(getVal(it, fieldMap_1, 'CommenterPar', ['CommenterPar']))
                        };
                    })
...
function updateAnnonceLikedBy(siteUrl, itemId, likedBy) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var ok;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, index_1.patchField)(siteUrl, LIST_NAME, itemId, 'AimePar', likedBy)];
                case 1:
                    ok = _a.sent();
                    if (ok)
                        invalidateCache();
...
function updateAnnonceComments(siteUrl, itemId, comments) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var ok;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, index_1.patchField)(siteUrl, LIST_NAME, itemId, 'CommenterPar', comments)];
                case 1:
                    ok = _a.sent();
                    if (ok)
                        invalidateCache();
