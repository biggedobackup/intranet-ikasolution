...
function updateAnnonceLikedBy(siteUrl, itemId, likedBy) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            return [2 /*return*/, (0, index_1.patchField)(siteUrl, LIST_NAME, itemId, 'AimePar', likedBy)];
        });
    });
}
function updateAnnonceComments(siteUrl, itemId, comments) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            return [2 /*return*/, (0, index_1.patchField)(siteUrl, LIST_NAME, itemId, 'CommenterPar', comments)];
        });
    });
}
