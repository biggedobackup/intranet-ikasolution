...
exports.VACANCE_STATUTS = void 0;
exports.formatDateFR = formatDateFR;
exports.loadVacances = loadVacances;
exports.loadVacance = loadVacance;
exports.createVacance = createVacance;
exports.updateVacance = updateVacance;
exports.deleteVacance = deleteVacance;
exports.loadVacanceAttachment = loadVacanceAttachment;
exports.uploadVacanceAttachment = uploadVacanceAttachment;
exports.removeVacanceAttachment = removeVacanceAttachment;
exports.applyVacanceDecision = applyVacanceDecision;
var tslib_1 = require("tslib");
var index_1 = require("../../shared/index");
exports.VACANCE_STATUTS = ['En attente', 'Approuvé', 'Refusé', 'Annulé'];
...
function mapItem(it, keys) {
    ...
    return {
        ...
        destination: asString((0, index_1.getVal)(it, keys.fieldMap, 'Destination', ['Destination'])),
        dateDebut: toIsoDate((0, index_1.getVal)(it, keys.fieldMap, 'Date Début', ['DateDebut'])),
        dateFin: toIsoDate((0, index_1.getVal)(it, keys.fieldMap, 'DateFin', ['DateFin'])),
...
function loadVacances(siteUrl, force) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
...
function loadVacance(siteUrl, id) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
...
function createVacance(siteUrl, payload) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            switch (_b.label) {
                ...
                case 5:
                    ...
                    if (id && payload.validateurEmail) {
                        link = "".concat((0, index_1.getAppPageUrl)(), "#page-workflow-detail-vacances&id=").concat(id);
                        subject = "Nouvelle demande de vacances \u00E0 valider : ".concat(payload.titre);
                        body = "<p>Bonjour,</p>\n<p><strong>".concat((0, index_1.escapeHtml)(currentUser.title), "</strong> a soumis une nouvelle demande de vacances : <strong>").concat((0, index_1.escapeHtml)(payload.titre), "</strong>.</p>\n<p>Destination : ").concat((0, index_1.escapeHtml)(payload.destination), "<br/>P\u00E9riode : du ").concat(formatDateFR(payload.dateDebut), " au ").concat(formatDateFR(payload.dateFin), " (").concat(payload.jours, " jour(s))</p>\n<p>Motif : ").concat((0, index_1.escapeHtml)(payload.motif), "</p>\n<p><a href=\"").concat(link, "\">Consulter et traiter la demande</a></p>");
...
function updateVacance(siteUrl, id, payload) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
...
function deleteVacance(siteUrl, id) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var ok;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
...
function loadVacanceAttachment(siteUrl, id) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var files;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
...
function uploadVacanceAttachment(siteUrl, id, file) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
...
function removeVacanceAttachment(siteUrl, id, fileName) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
...
function applyVacanceDecision(siteUrl, vacance, action, comment, date) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    fields = (_a = {},
                        ...
                        _a);
                    return [4 /*yield*/, (0, index_1.updateListItemFields)(siteUrl, LIST_NAME, vacance.id, fields)];
                case 2:
                    ok = _b.sent();
                    if (ok) {
                        invalidateCache();
                        if (vacance.demandeurEmail) {
                            ...
                            link = "".concat((0, index_1.getAppPageUrl)(), "#page-workflow-detail-vacances&id=").concat(vacance.id);
                            subject = approved ? "Votre demande de vacances a \u00E9t\u00E9 approuv\u00E9e" : "Votre demande de vacances a \u00E9t\u00E9 refus\u00E9e";
                            body = "<p>Bonjour ".concat((0, index_1.escapeHtml)(vacance.demandeur), ",</p>\n<p>Votre demande de vacances <strong>").concat((0, index_1.escapeHtml)(vacance.titre), "</strong> a \u00E9t\u00E9 ").concat(approved ? 'approuvée' : 'refusée', ".</p>\n").concat(comment ? "<p>Commentaire : ".concat((0, index_1.escapeHtml)(comment), "</p>") : '', "\n<p><a href=\"").concat(link, "\">Voir la demande</a></p>");
                            (0, index_1.sendEmail)(siteUrl, [vacance.demandeurEmail], subject, body).catch(function () { return undefined; });
                        }
                    }
                    return [2 /*return*/, ok];
                case 3:
