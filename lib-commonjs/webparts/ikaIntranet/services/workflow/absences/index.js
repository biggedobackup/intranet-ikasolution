...
exports.ABSENCE_STATUTS = exports.ABSENCE_TYPES = void 0;
exports.formatDateFR = formatDateFR;
exports.loadAbsences = loadAbsences;
exports.loadAbsence = loadAbsence;
exports.createAbsence = createAbsence;
exports.updateAbsence = updateAbsence;
exports.deleteAbsence = deleteAbsence;
exports.loadAbsenceAttachment = loadAbsenceAttachment;
exports.uploadAbsenceAttachment = uploadAbsenceAttachment;
exports.removeAbsenceAttachment = removeAbsenceAttachment;
exports.applyAbsenceDecision = applyAbsenceDecision;
var tslib_1 = require("tslib");
var index_1 = require("../../shared/index");
exports.ABSENCE_TYPES = ['Maladie', 'Autorisée', 'Imprévue', 'Rendez-vous'];
exports.ABSENCE_STATUTS = ['En attente', 'Approuvé', 'Refusé', 'Annulé'];
...
function mapItem(it, keys) {
    ...
    return {
        ...
        type: asString((0, index_1.getVal)(it, keys.fieldMap, 'Type Absence', ['TypeAbsence'])),
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    fields = (_a = {},
                        ...
                        _a);
                    return [4 /*yield*/, (0, index_1.updateListItemFields)(siteUrl, LIST_NAME, absence.id, fields)];
                case 2:
                    ok = _b.sent();
                    if (ok) {
                        invalidateCache();
                        if (absence.demandeurEmail) {
                            ...
                            link = "".concat((0, index_1.getAppPageUrl)(), "#page-workflow-detail-absence&id=").concat(absence.id);
                            subject = approved ? "Votre signalement d'absence a \u00E9t\u00E9 approuv\u00E9" : "Votre signalement d'absence a \u00E9t\u00E9 refus\u00E9";
                            body = "<p>Bonjour ".concat((0, index_1.escapeHtml)(absence.demandeur), ",</p>\n<p>Votre signalement d'absence <strong>").concat((0, index_1.escapeHtml)(absence.titre), "</strong> a \u00E9t\u00E9 ").concat(approved ? 'approuvé' : 'refusé', ".</p>\n").concat(comment ? "<p>Commentaire : ".concat((0, index_1.escapeHtml)(comment), "</p>") : '', "\n<p><a href=\"").concat(link, "\">Voir le signalement</a></p>");
                            (0, index_1.sendEmail)(siteUrl, [absence.demandeurEmail], subject, body).catch(function () { return undefined; });
                        }
                    }
                    return [2 /*return*/, ok];
                case 3:
