...
exports.loadActualites = loadActualites;
exports.updateActualiteLikedBy = updateActualiteLikedBy;
exports.updateActualiteComments = updateActualiteComments;
...
function loadActualites(siteUrl) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        var cached, fieldMap, listName_1, fieldMapFinal_1, _a, res, items, missingImages_1, actualites_1, rootFolder_1, err_1;
        var _this = this;
        return tslib_1.__generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 7:
                    ...
                    actualites_1 = items
                        ...
                        return {
                            ...
                            likedBy: (0, index_1.parseLikedBy)(getVal(it, fieldMapFinal_1, 'AimerPar', ['AimerPar'])),
