...
var index_4 = require("../services/equipe/index");
var index_5 = require("../services/projets/index");
var index_6 = require("../services/produits/index");
var index_7 = require("../services/annonces/index");
var index_8 = require("../services/employes-mois/index");
var index_9 = require("../services/bilans/index");
var index_10 = require("../services/galerie/index");
var index_11 = require("../services/shared/index");
...
var Accueil = function (_a) {
    ...
    React.useEffect(function () {
        ...
        (0, index_6.loadProduits)(siteUrl)
            .then(function (data) {
            setProduits(data);
            setProduitsLoading(false);
        })
        ...
        (0, index_7.loadAnnonces)(siteUrl)
            .then(function (data) {
            setAnnonces(data);
            setAnnoncesLoading(false);
        })
        ...
        (0, index_8.loadEmployesMois)(siteUrl)
            .then(function (data) {
        ...
        (0, index_10.getGalerieRootFolder)(siteUrl)
            .then(function (root) { return (0, index_10.loadGalerieFolders)(siteUrl, root); })
        ...
        (0, index_11.getCurrentUserEmail)(siteUrl)
            .then(setUserEmail)
            .catch(function (err) {
            console.error('[Accueil] Email courant :', err);
        });
        (0, index_11.getCurrentUserName)(siteUrl)
            .then(setUserName)
            .catch(function (err) {
    ...
    var openGalerieFolder = function (folder) {
        if (!siteUrl)
            return;
        (0, index_10.loadGalerieImages)(siteUrl, folder.serverRelativeUrl)
    ...
    var toggleLike = function () {
        ...
        var newLikedBy = isLiked ? current.filter(function (e) { return e !== userEmail; }) : tslib_1.__spreadArray(tslib_1.__spreadArray([], current, true), [userEmail], false);
        setEmpMoisLikes(function (prev) {
            var _a;
            return (tslib_1.__assign(tslib_1.__assign({}, prev), (_a = {}, _a[id] = newLikedBy, _a)));
        });
        (0, index_8.updateEmployeMoisLikedBy)(siteUrl, id, newLikedBy).catch(function (err) {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    newComments = tslib_1.__spreadArray(tslib_1.__spreadArray([], (empMoisComments[id] || []), true), [newComment], false);
                    setEmpMoisComments(function (prev) {
                        var _a;
                        return (tslib_1.__assign(tslib_1.__assign({}, prev), (_a = {}, _a[id] = newComments, _a)));
                    });
                    setCommentInput('');
                    setCommentModal(false);
                    return [4 /*yield*/, (0, index_8.updateEmployeMoisComments)(siteUrl, id, newComments)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    var toggleAnnLike = function (id) {
        ...
        (0, index_7.updateAnnonceLikedBy)(siteUrl, id, newLikedBy).catch(function (err) {
            console.error('[Accueil] Like annonce :', err);
        });
    };
    var addAnnonceComment = function (e) { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        var val, id, newComment, newComments;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    newComments = tslib_1.__spreadArray(tslib_1.__spreadArray([], (annComments[id] || []), true), [newComment], false);
                    ...
                    return [4 /*yield*/, (0, index_7.updateAnnonceComments)(siteUrl, id, newComments)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
                                ...
                                React.createElement("tbody", { className: "divide-y divide-slate-100 text-slate-700" },
                                    ...
                                    !teamLoading && filteredTeam.map(function (m) { return (React.createElement("tr", { key: m.id, onClick: function () { return setMemberModal(m); }, className: "cursor-pointer hover:bg-slate-50 transition" },
                                        ...
                                        React.createElement("td", { className: "py-2 px-2" },
                                            React.createElement("span", { className: "px-2 py-0.5 rounded font-semibold text-[10px] ".concat(index_4.DEPT_COLORS[m.dept] || 'bg-slate-100 text-slate-700') }, m.dept)),
                ...
                React.createElement("section", { id: "galerie", className: "lg:col-span-6 bg-white rounded-2xl p-5 shadow-sm border border-slate-200 flex flex-col justify-between" },
                    React.createElement("div", null,
                        ...
                        galerieActiveFolder && (React.createElement("button", { onClick: function () {
                            ...
                            React.createElement(fa6_1.FaArrowLeft, { className: "text-[9px]" }),
                            " Tous les dossiers")),
            ...
            React.createElement("div", { className: "bg-white rounded-2xl max-w-md w-full shadow-2xl border border-slate-200 overflow-hidden relative" },
                ...
                React.createElement("div", { className: "pt-14 px-6 pb-6 space-y-4" },
                    React.createElement("div", null,
                        ...
                        React.createElement("span", { className: "inline-block mt-1.5 px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider ".concat(index_4.DEPT_COLORS[memberModal.dept] || 'bg-slate-100 text-slate-700') }, memberModal.dept)),
