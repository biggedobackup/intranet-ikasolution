...
var data_1 = require("../../services/evenements/data");
...
var DetailEvenement = function () {
    ...
    var event = data_1.EVENEMENTS.find(function (e) { return e.id === eventId; }) || data_1.EVENEMENTS[0];
    var idx = data_1.EVENEMENTS.findIndex(function (e) { return e.id === event.id; });
    var prev = data_1.EVENEMENTS[(idx - 1 + data_1.EVENEMENTS.length) % data_1.EVENEMENTS.length];
    var next = data_1.EVENEMENTS[(idx + 1) % data_1.EVENEMENTS.length];
            ...
            React.createElement("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-4" },
                ...
                React.createElement("aside", { className: "space-y-4" },
                    React.createElement("div", { className: "bg-white rounded-2xl p-5 shadow-sm border border-slate-200" },
                        ...
                        React.createElement("div", { className: "grid grid-cols-1 gap-4" }, data_1.EVENEMENTS.filter(function (e) { return e.id !== event.id; }).map(function (e) { return (React.createElement(EventCard, { key: e.id, event: e })); }))),
