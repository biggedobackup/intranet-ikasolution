...
var TousEvenements = function () {
    ...
    var categories = tslib_1.__spreadArray(['all'], Array.from(new Set(data_1.EVENEMENTS.map(function (e) { return e.category; }))), true);
    var filtered = data_1.EVENEMENTS.filter(function (e) {
