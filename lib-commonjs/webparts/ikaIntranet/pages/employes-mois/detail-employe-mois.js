...
var DetailEmployeMois = function (_a) {
    ...
    var toggleLike = function () {
        ...
        var newLikedBy = isLiked ? likedBy.filter(function (e) { return e !== userEmail; }) : tslib_1.__spreadArray(tslib_1.__spreadArray([], likedBy, true), [userEmail], false);
        setLikedBy(newLikedBy);
        (0, index_1.updateEmployeMoisLikedBy)(siteUrl, employe.id, newLikedBy).catch(function (err) {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, index_1.updateEmployeMoisComments)(siteUrl, employe.id, newComments)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
