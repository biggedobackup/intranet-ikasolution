...
var DetailAbsence = function () {
    var _a = React.useState(function () { return data_1.ABSENCES.find(function (a) { return a.id === getAbsenceIdFromHash(); }) || data_1.ABSENCES[0]; }), absence = _a[0], setAbsence = _a[1];
    var _b = React.useState(null), decision = _b[0], setDecision = _b[1];
    React.useEffect(function () {
        var onHash = function () {
            var id = getAbsenceIdFromHash();
            setAbsence(data_1.ABSENCES.find(function (a) { return a.id === id; }) || data_1.ABSENCES[0]);
            setDecision(null);
        };
    ...
    var handleDecision = function (comment, date) {
        if (!decision)
            return;
        setAbsence(function (prev) { return (0, DecisionValidation_1.applyAbsenceDecision)(prev, decision, comment, date); });
        setDecision(null);
    };
