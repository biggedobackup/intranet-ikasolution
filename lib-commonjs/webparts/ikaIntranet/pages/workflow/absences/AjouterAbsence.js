...
var emptyForm = { titre: '', type: index_1.ABSENCE_TYPES[0], dateDebut: '', dateFin: '', jours: '', motif: '', validateurEmail: '' };
function formFromExisting(existing) {
    return {
        titre: existing.titre,
        type: existing.type || index_1.ABSENCE_TYPES[0],
...
var AjouterAbsence = function (props) {
    ...
    React.useEffect(function () {
        ...
        if (isEdit && id) {
            ...
            (0, index_1.loadAbsence)(siteUrl, id)
                ...
                setLoading(false);
                (0, index_1.loadAbsenceAttachment)(siteUrl, id).then(function (att) { if (!cancelled)
    ...
    var handleRemoveAttachment = function () {
        if (!siteUrl || !id || !existingAttachment)
            return;
        (0, index_1.removeAbsenceAttachment)(siteUrl, id, existingAttachment.fileName)
    ...
    var handleSubmit = function (e) {
        ...
        var afterSave = function (ok, targetId) {
            if (ok && targetId && file) {
                (0, index_1.uploadAbsenceAttachment)(siteUrl, targetId, file)
        ...
        if (isEdit && id) {
            (0, index_1.updateAbsence)(siteUrl, id, payload).then(function (ok) { return afterSave(ok, id); }).catch(function () { return finish(false); });
        }
        else {
            (0, index_1.createAbsence)(siteUrl, payload).then(function (createdId) { return afterSave(!!createdId, createdId); }).catch(function () { return finish(false); });
        }
    };
            ...
            React.createElement("div", { className: "mx-auto max-w-2xl px-4 sm:px-6 lg:px-8" },
                React.createElement("div", { className: "bg-white rounded-2xl p-10 shadow-sm border border-slate-200 text-center" },
                    ...
                    React.createElement("div", { className: "mt-6 flex flex-col sm:flex-row items-center justify-center gap-3" },
                        newId ? (React.createElement("a", { href: "#page-workflow-detail-absence&id=".concat(newId), className: "inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-ikaBlue text-white font-bold text-xs hover:bg-blue-600 shadow transition" }, "Voir le signalement")) : null,
    ...
    return (React.createElement("main", { className: "pt-6 sm:pt-8 pb-14 min-h-screen bg-slate-100 text-slate-800" },
        React.createElement("div", { className: "mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 space-y-4" },
            React.createElement("nav", { className: "flex items-center gap-2 text-[11px] font-semibold text-slate-500 flex-wrap" },
                ...
                React.createElement("span", null, "/"),
                React.createElement("span", { className: "text-ikaBlue" }, isEdit ? "Modifier : ".concat(form.titre || '') : "Nouveau signalement d'absence")),
            React.createElement("div", { className: "bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden" },
                React.createElement("div", { className: "px-6 sm:px-8 py-5 border-b border-slate-100" },
                    ...
                    React.createElement("p", { className: "mt-1 text-xs text-slate-500" }, "Le signalement sera transmis au validateur indiqu\u00E9.")),
                React.createElement("form", { onSubmit: handleSubmit, className: "p-6 sm:p-8 space-y-5" },
                    ...
                    React.createElement("div", null,
                        ...
                        React.createElement("input", { type: "text", value: form.titre, onChange: function (e) { return setField('titre', e.target.value); }, required: true, placeholder: "Titre du signalement", className: "".concat(inputCls, " ").concat(errors.titre ? 'border-rose-300' : '') }),
                    ...
                    React.createElement("div", null,
                        ...
                        React.createElement("select", { value: form.type, onChange: function (e) { return setField('type', e.target.value); }, className: inputCls }, index_1.ABSENCE_TYPES.map(function (t) { return React.createElement("option", { key: t, value: t }, t); }))),
                    ...
                    React.createElement("div", null,
                        ...
                        React.createElement("textarea", { value: form.motif, onChange: function (e) { return setField('motif', e.target.value); }, required: true, rows: 4, placeholder: "D\u00E9crivez le motif de votre absence...", className: "".concat(inputCls, " ").concat(errors.motif ? 'border-rose-300' : '') }),
