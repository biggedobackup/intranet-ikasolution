...
exports.AjouterConge = void 0;
var tslib_1 = require("tslib");
var React = tslib_1.__importStar(require("react"));
var fa6_1 = require("react-icons/fa6");
var index_1 = require("../../../services/workflow/conges/index");
...
function formFromExisting(existing) {
    return {
        ...
        type: existing.type || index_1.CONGE_TYPES[0],
...
var AjouterConge = function (props) {
    ...
    React.useEffect(function () {
        ...
        if (isEdit && id) {
            setLoading(true);
            (0, index_1.loadConge)(siteUrl, id)
                ...
                setLoading(false);
                (0, index_1.loadCongeAttachment)(siteUrl, id).then(function (att) { if (!cancelled)
    ...
    var handleRemoveAttachment = function () {
        if (!siteUrl || !id || !existingAttachment)
            return;
        (0, index_1.removeCongeAttachment)(siteUrl, id, existingAttachment.fileName)
    ...
    var handleSubmit = function (e) {
        ...
        var afterSave = function (ok, targetId) {
            if (ok && targetId && file) {
                (0, index_1.uploadCongeAttachment)(siteUrl, targetId, file)
        ...
        if (isEdit && id) {
            (0, index_1.updateConge)(siteUrl, id, payload).then(function (ok) { return afterSave(ok, id); }).catch(function () { return finish(false); });
        }
        else {
            (0, index_1.createConge)(siteUrl, payload).then(function (createdId) { return afterSave(!!createdId, createdId); }).catch(function () { return finish(false); });
        }
    };
            ...
            React.createElement("div", { className: "bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden" },
                ...
                React.createElement("form", { onSubmit: handleSubmit, className: "p-6 sm:p-8 space-y-5" },
                    ...
                    React.createElement("div", null,
                        ...
                        React.createElement("select", { value: form.type, onChange: function (e) { return setField('type', e.target.value); }, className: inputCls }, index_1.CONGE_TYPES.map(function (t) { return React.createElement("option", { key: t, value: t }, t); }))),
...
exports.AjouterConge = AjouterConge;
exports.default = exports.AjouterConge;
