...
var ListeVacances = function (props) {
    ...
    var fetchItems = React.useCallback(function (force) {
        ...
        setLoading(true);
        (0, index_1.loadVacances)(siteUrl, force)
            .then(function (data) { setItems(data); setLoading(false); })
            .catch(function () { setError('Impossible de charger les demandes de vacances.'); setLoading(false); });
    }, [siteUrl]);
    ...
    var filtered = items.filter(function (i) {
        ...
        var matchesSearch = i.titre.toLowerCase().indexOf(q) !== -1 || i.demandeur.toLowerCase().indexOf(q) !== -1 || i.destination.toLowerCase().indexOf(q) !== -1;
    ...
    var handleConfirmDelete = function () {
        if (!siteUrl || !deleteItem)
            return;
        setDeleting(true);
        (0, index_1.deleteVacance)(siteUrl, deleteItem.id)
            .then(function (ok) {
            setDeleting(false);
            if (ok) {
    ...
    return (React.createElement("main", { className: "pt-6 sm:pt-8 pb-14 min-h-screen bg-slate-100 text-slate-800" },
        React.createElement("div", { className: "mx-auto max-w-[1650px] px-4 sm:px-6 lg:px-8 space-y-4" },
            React.createElement("div", { className: "bg-white rounded-2xl p-6 sm:p-8 shadow-sm border border-slate-200 relative overflow-hidden" },
                ...
                React.createElement("div", { className: "relative" },
                    React.createElement("nav", { className: "flex items-center gap-2 text-[11px] font-semibold text-slate-500 flex-wrap" },
                        ...
                        React.createElement("span", { className: "text-ikaBlue" }, "Vacances")),
                    React.createElement("div", { className: "mt-3 flex flex-col sm:flex-row sm:items-center justify-between gap-4" },
                        React.createElement("div", null,
                            React.createElement("h1", { className: "text-2xl sm:text-3xl font-black text-ikaBlueDark" }, "Vacances"),
                            React.createElement("p", { className: "mt-2 text-sm text-slate-500 max-w-2xl" }, "Consultez, ajoutez ou modifiez les demandes de vacances.")),
                        React.createElement("a", { href: "#page-workflow-ajouter-vacances", className: "inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-ikaBlue text-white font-bold text-xs hover:bg-blue-600 shadow transition shrink-0" },
                            React.createElement(fa6_1.FaPlus, null),
                            " Nouvelle demande de vacances")),
            ...
            loading ? (React.createElement("div", { className: "bg-white rounded-2xl p-10 shadow-sm border border-slate-200 text-center" },
                React.createElement("p", { className: "text-sm text-slate-500 font-semibold" }, "Chargement des demandes..."))) : filtered.length === 0 ? (React.createElement("div", { className: "bg-white rounded-2xl p-10 shadow-sm border border-slate-200 text-center" },
                    ...
                    React.createElement("table", { className: "w-full text-left text-xs min-w-[900px]" },
                        React.createElement("thead", null,
                            React.createElement("tr", { className: "border-b border-slate-200 text-slate-400 font-bold uppercase text-[10px]" },
                                ...
                                React.createElement("th", { className: "py-3 px-4" }, "Destination"),
                        ...
                        React.createElement("tbody", { className: "divide-y divide-slate-100 text-slate-700" }, paginated.map(function (i) { return (React.createElement("tr", { key: i.id, className: "hover:bg-slate-50 transition" },
                            ...
                            React.createElement("td", { className: "py-3 px-4" },
                                React.createElement("span", { className: "flex items-center gap-1.5 text-slate-500" },
                                    ...
                                    " ",
                                    i.demandeur || '—')),
                            React.createElement("td", { className: "py-3 px-4 text-slate-500" }, i.destination),
                            React.createElement("td", { className: "py-3 px-4" },
                                React.createElement("span", { className: "flex items-center gap-1.5 text-slate-500" },
                            ...
                            React.createElement("td", { className: "py-3 px-4 text-right" },
                                React.createElement("div", { className: "inline-flex items-center gap-1.5" },
                                    React.createElement("a", { href: "#page-workflow-detail-vacances&id=".concat(i.id), className: "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-blue-200 bg-blue-50 text-ikaBlue font-bold text-[10px] hover:bg-blue-100 transition" },
                                        React.createElement(fa6_1.FaEye, { className: "text-[9px]" }),
                                        " D\u00E9tail"),
                                    React.createElement("a", { href: "#page-workflow-modifier-vacances&id=".concat(i.id), className: "inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-200 text-ikaBlue font-bold text-[10px] hover:bg-ikaSoft transition" },
        ...
        deleteItem ? (React.createElement(ConfirmDelete_1.ConfirmDelete, { title: "Supprimer la demande", message: "Voulez-vous vraiment supprimer la demande de vacances \u00AB ".concat(deleteItem.titre, " \u00BB de ").concat(deleteItem.demandeur, " ? Cette action est irr\u00E9versible."), onConfirm: handleConfirmDelete, onCancel: function () { return !deleting && setDeleteItem(null); } })) : null));
};
exports.ListeVacances = ListeVacances;
exports.default = exports.ListeVacances;
//# sourceMappingURL=ListeVacances.js.map