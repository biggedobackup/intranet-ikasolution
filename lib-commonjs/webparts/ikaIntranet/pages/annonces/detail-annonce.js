        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, index_1.updateAnnonceLikedBy)(siteUrl, annonce.id, newLikedBy)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, index_1.updateAnnonceComments)(siteUrl, annonce.id, newComments)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
