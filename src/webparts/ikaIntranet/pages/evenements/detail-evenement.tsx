  ...
  return (
    ...
    >
      <div className="relative h-44 overflow-hidden">
        <img src={event.img} alt={event.title} className="w-full h-full object-cover object-center group-hover:scale-105 transition duration-500" loading="lazy" />
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            <div className="p-5 sm:p-8">
              ...
              <div className="mt-6 flex items-center gap-2">
                ...
                >
                  <FaCircleCheck className={isJoined ? '' : 'text-xs'} /> J&apos;aime ({likedBy.length})
                </button>
              </div>
          ...
          <aside className="space-y-4">
            <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-200">
              ...
              <div className="grid grid-cols-1 gap-4">
                {items.filter((e) => e.id !== event.id).sort((a, b) => b.id - a.id).slice(0, 3).map((e) => (
