...
/***/ 3075
/*!************************************************************************!*\
  !*** ./lib/webparts/ikaIntranet/pages/workflow/conges/AjouterConge.js ***!
  \************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AjouterConge: () => (/* binding */ AjouterConge),
...
/* harmony import */ var _services_workflow_conges_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/workflow/conges/index */ 3011);
...
var emptyForm = {
    titre: '',
    type: _services_workflow_conges_index__WEBPACK_IMPORTED_MODULE_3__.CONGE_TYPES[0],
    dateDebut: '',
    dateFin: '',
    jours: '',
    motif: '',
...
function formFromExisting(existing) {
    return {
        ...
        type: existing.type || _services_workflow_conges_index__WEBPACK_IMPORTED_MODULE_3__.CONGE_TYPES[0],
...
var AjouterConge = function (props) {
    ...
    react__WEBPACK_IMPORTED_MODULE_1__.useEffect(function () {
        ...
        if (isEdit && id) {
            setLoading(true);
            (0,_services_workflow_conges_index__WEBPACK_IMPORTED_MODULE_3__.loadConge)(siteUrl, id)
                ...
                setLoading(false);
                (0,_services_workflow_conges_index__WEBPACK_IMPORTED_MODULE_3__.loadCongeAttachment)(siteUrl, id).then(function (att) { if (!cancelled)
    ...
    var handleRemoveAttachment = function () {
        if (!siteUrl || !id || !existingAttachment)
            return;
        (0,_services_workflow_conges_index__WEBPACK_IMPORTED_MODULE_3__.removeCongeAttachment)(siteUrl, id, existingAttachment.fileName)
    ...
    var handleSubmit = function (e) {
        ...
        var afterSave = function (ok, targetId) {
            if (ok && targetId && file) {
                (0,_services_workflow_conges_index__WEBPACK_IMPORTED_MODULE_3__.uploadCongeAttachment)(siteUrl, targetId, file)
        ...
        if (isEdit && id) {
            (0,_services_workflow_conges_index__WEBPACK_IMPORTED_MODULE_3__.updateConge)(siteUrl, id, payload).then(function (ok) { return afterSave(ok, id); }).catch(function () { return finish(false); });
        }
        else {
            (0,_services_workflow_conges_index__WEBPACK_IMPORTED_MODULE_3__.createConge)(siteUrl, payload).then(function (createdId) { return afterSave(!!createdId, createdId); }).catch(function () { return finish(false); });
        }
    };
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("main", { className: "pt-6 sm:pt-8 pb-14 min-h-screen bg-slate-100 text-slate-800" },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "mx-auto max-w-2xl px-4 sm:px-6 lg:px-8" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "bg-white rounded-2xl p-10 shadow-sm border border-slate-200 text-center" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("a", { href: "#page-workflow-liste-conge", className: "mt-4 inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-ikaBlue text-white font-bold text-xs hover:bg-blue-600 shadow transition" },
            ...
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "mx-auto max-w-2xl px-4 sm:px-6 lg:px-8" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "bg-white rounded-2xl p-10 shadow-sm border border-slate-200 text-center" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "mt-6 flex flex-col sm:flex-row items-center justify-center gap-3" },
                        newId ? (react__WEBPACK_IMPORTED_MODULE_1__.createElement("a", { href: "#page-workflow-detail-conge&id=".concat(newId), className: "inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-ikaBlue text-white font-bold text-xs hover:bg-blue-600 shadow transition" }, "Voir la demande")) : null,
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement("a", { href: "#page-workflow-liste-conge", className: "inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl border border-slate-200 bg-white text-slate-700 font-bold text-xs hover:bg-slate-50 transition" },
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement(react_icons_fa6__WEBPACK_IMPORTED_MODULE_2__.FaArrowLeft, null),
                            " Retour \u00E0 la liste"))))));
    }
    return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("main", { className: "pt-6 sm:pt-8 pb-14 min-h-screen bg-slate-100 text-slate-800" },
        react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 space-y-4" },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("nav", { className: "flex items-center gap-2 text-[11px] font-semibold text-slate-500 flex-wrap" },
                ...
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("a", { href: "#page-workflow-liste-conge", className: "hover:text-ikaBlue transition" }, "Demandes de Cong\u00E9"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("span", null, "/"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("span", { className: "text-ikaBlue" }, isEdit ? "Modifier : ".concat(form.titre || '') : 'Nouvelle demande de congé')),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "px-6 sm:px-8 py-5 border-b border-slate-100" },
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("h1", { className: "text-xl sm:text-2xl font-black text-ikaBlueDark" }, isEdit ? 'Modifier la demande de congé' : 'Nouvelle demande de congé'),
                ...
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("form", { onSubmit: handleSubmit, className: "p-6 sm:p-8 space-y-5" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", null,
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", { className: "block text-xs font-bold text-slate-700 mb-1.5" }, "Type de cong\u00E9"),
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement("select", { value: form.type, onChange: function (e) { return setField('type', e.target.value); }, className: inputCls }, _services_workflow_conges_index__WEBPACK_IMPORTED_MODULE_3__.CONGE_TYPES.map(function (t) { return react__WEBPACK_IMPORTED_MODULE_1__.createElement("option", { key: t, value: t }, t); }))),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AjouterConge);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("abec150f849a713d9908")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=ika-intranet-web-part.279b0f9bf8d6c98b801c.hot-update.js.map