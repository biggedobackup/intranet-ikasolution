...
/***/ 171
/*!****************************************************************************!*\
  !*** ./lib/webparts/ikaIntranet/pages/workflow/absences/AjouterAbsence.js ***!
  \****************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AjouterAbsence: () => (/* binding */ AjouterAbsence),
...
/* harmony import */ var _services_workflow_absences_index__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../services/workflow/absences/index */ 8778);
...
var emptyForm = { titre: '', type: _services_workflow_absences_index__WEBPACK_IMPORTED_MODULE_3__.ABSENCE_TYPES[0], dateDebut: '', dateFin: '', jours: '', motif: '', validateurEmail: '' };
function formFromExisting(existing) {
    return {
        titre: existing.titre,
        type: existing.type || _services_workflow_absences_index__WEBPACK_IMPORTED_MODULE_3__.ABSENCE_TYPES[0],
...
var AjouterAbsence = function (props) {
    ...
    react__WEBPACK_IMPORTED_MODULE_1__.useEffect(function () {
        ...
        if (isEdit && id) {
            setLoading(true);
            (0,_services_workflow_absences_index__WEBPACK_IMPORTED_MODULE_3__.loadAbsence)(siteUrl, id)
                ...
                setLoading(false);
                (0,_services_workflow_absences_index__WEBPACK_IMPORTED_MODULE_3__.loadAbsenceAttachment)(siteUrl, id).then(function (att) { if (!cancelled)
    ...
    var handleRemoveAttachment = function () {
        if (!siteUrl || !id || !existingAttachment)
            return;
        (0,_services_workflow_absences_index__WEBPACK_IMPORTED_MODULE_3__.removeAbsenceAttachment)(siteUrl, id, existingAttachment.fileName)
    ...
    var handleSubmit = function (e) {
        ...
        var afterSave = function (ok, targetId) {
            if (ok && targetId && file) {
                (0,_services_workflow_absences_index__WEBPACK_IMPORTED_MODULE_3__.uploadAbsenceAttachment)(siteUrl, targetId, file)
                    .then(function (uploaded) { if (!uploaded)
                    setAttachmentWarning("Le signalement a été enregistré mais l'envoi de la pièce jointe a échoué."); finish(ok, targetId); })
                    .catch(function () { setAttachmentWarning("Le signalement a été enregistré mais l'envoi de la pièce jointe a échoué."); finish(ok, targetId); });
                return;
            }
            finish(ok, targetId);
        };
        if (isEdit && id) {
            (0,_services_workflow_absences_index__WEBPACK_IMPORTED_MODULE_3__.updateAbsence)(siteUrl, id, payload).then(function (ok) { return afterSave(ok, id); }).catch(function () { return finish(false); });
        }
        else {
            (0,_services_workflow_absences_index__WEBPACK_IMPORTED_MODULE_3__.createAbsence)(siteUrl, payload).then(function (createdId) { return afterSave(!!createdId, createdId); }).catch(function () { return finish(false); });
        }
    };
    ...
    if (loading) {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("main", { className: "pt-6 sm:pt-8 pb-14 min-h-screen bg-slate-100 text-slate-800" },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "mx-auto max-w-2xl px-4 sm:px-6 lg:px-8" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "bg-white rounded-2xl p-10 shadow-sm border border-slate-200 text-center text-sm text-slate-500 font-semibold" }, "Chargement du signalement..."))));
    }
    if (notFound) {
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("main", { className: "pt-6 sm:pt-8 pb-14 min-h-screen bg-slate-100 text-slate-800" },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "mx-auto max-w-2xl px-4 sm:px-6 lg:px-8" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "bg-white rounded-2xl p-10 shadow-sm border border-slate-200 text-center" },
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", { className: "text-sm text-slate-500 font-semibold" }, "Signalement introuvable."),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("a", { href: "#page-workflow-liste-absence", className: "mt-4 inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-ikaBlue text-white font-bold text-xs hover:bg-blue-600 shadow transition" },
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("main", { className: "pt-6 sm:pt-8 pb-14 min-h-screen bg-slate-100 text-slate-800" },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "mx-auto max-w-2xl px-4 sm:px-6 lg:px-8" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "bg-white rounded-2xl p-10 shadow-sm border border-slate-200 text-center" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("h1", { className: "mt-4 text-xl font-black text-ikaBlueDark" }, isEdit ? 'Signalement modifié' : 'Signalement envoyé'),
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "mt-6 flex flex-col sm:flex-row items-center justify-center gap-3" },
                        newId ? (react__WEBPACK_IMPORTED_MODULE_1__.createElement("a", { href: "#page-workflow-detail-absence&id=".concat(newId), className: "inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-ikaBlue text-white font-bold text-xs hover:bg-blue-600 shadow transition" }, "Voir le signalement")) : null,
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement("a", { href: "#page-workflow-liste-absence", className: "inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl border border-slate-200 bg-white text-slate-700 font-bold text-xs hover:bg-slate-50 transition" },
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement(react_icons_fa6__WEBPACK_IMPORTED_MODULE_2__.FaArrowLeft, null),
                            " Retour \u00E0 la liste"))))));
    }
    return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("main", { className: "pt-6 sm:pt-8 pb-14 min-h-screen bg-slate-100 text-slate-800" },
        react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 space-y-4" },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("nav", { className: "flex items-center gap-2 text-[11px] font-semibold text-slate-500 flex-wrap" },
                ...
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("a", { href: "#page-workflow-liste-absence", className: "hover:text-ikaBlue transition" }, "Signalements d'Absence"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("span", null, "/"),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("span", { className: "text-ikaBlue" }, isEdit ? "Modifier : ".concat(form.titre || '') : "Nouveau signalement d'absence")),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden" },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "px-6 sm:px-8 py-5 border-b border-slate-100" },
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("h1", { className: "text-xl sm:text-2xl font-black text-ikaBlueDark" }, isEdit ? "Modifier le signalement d'absence" : "Nouveau signalement d'absence"),
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("p", { className: "mt-1 text-xs text-slate-500" }, "Le signalement sera transmis au validateur indiqu\u00E9.")),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("form", { onSubmit: handleSubmit, className: "p-6 sm:p-8 space-y-5" },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", null,
                        ...
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement("input", { type: "text", value: form.titre, onChange: function (e) { return setField('titre', e.target.value); }, required: true, placeholder: "Titre du signalement", className: "".concat(inputCls, " ").concat(errors.titre ? 'border-rose-300' : '') }),
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", null,
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement("label", { className: "block text-xs font-bold text-slate-700 mb-1.5" }, "Type d'absence"),
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement("select", { value: form.type, onChange: function (e) { return setField('type', e.target.value); }, className: inputCls }, _services_workflow_absences_index__WEBPACK_IMPORTED_MODULE_3__.ABSENCE_TYPES.map(function (t) { return react__WEBPACK_IMPORTED_MODULE_1__.createElement("option", { key: t, value: t }, t); }))),
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", null,
                        ...
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement("textarea", { value: form.motif, onChange: function (e) { return setField('motif', e.target.value); }, required: true, rows: 4, placeholder: "D\u00E9crivez le motif de votre absence...", className: "".concat(inputCls, " ").concat(errors.motif ? 'border-rose-300' : '') }),
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3" },
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement("button", { type: "submit", disabled: saving, className: "inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-ikaBlue text-white font-bold text-xs hover:bg-blue-600 shadow transition disabled:opacity-60 disabled:cursor-not-allowed" },
                            ...
                            " ",
                            saving ? 'Enregistrement...' : (isEdit ? 'Enregistrer les modifications' : 'Envoyer le signalement')),
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement("a", { href: isEdit ? "#page-workflow-modifier-absence&id=".concat(id) : '#page-workflow-ajouter-absence', onClick: function (e) { e.preventDefault(); setForm(original ? formFromExisting(original) : emptyForm); setError(''); setFile(undefined); setErrors({}); }, className: "inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl border border-slate-200 bg-white text-slate-700 font-bold text-xs hover:bg-slate-50 transition" },
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AjouterAbsence);
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("ce7126ecff923d14f0f6")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=ika-intranet-web-part.d9642713d7aa750ebd8e.hot-update.js.map