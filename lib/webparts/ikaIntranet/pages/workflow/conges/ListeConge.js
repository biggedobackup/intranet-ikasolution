...
export var ListeConge = function () {
    ...
    var _d = React.useState(CONGES), items = _d[0], setItems = _d[1];
    ...
    return (React.createElement("main", { className: "pt-6 sm:pt-8 pb-14 min-h-screen bg-slate-100 text-slate-800" },
        ...
        deleteItem && (React.createElement(ConfirmDelete, { title: "Supprimer la demande", message: "Voulez-vous vraiment supprimer la demande de cong\u00E9 \u00AB ".concat(deleteItem.titre, " \u00BB de ").concat(deleteItem.demandeur, " ? Cette action est irr\u00E9versible."), onConfirm: function () { setItems(function (prev) { return prev.filter(function (x) { return x.id !== deleteItem.id; }); }); setDeleteItem(null); setPage(1); }, onCancel: function () { return setDeleteItem(null); } }))));
};
