...
import { loadConges, deleteConge, formatDateFR } from '../../../services/workflow/conges/index';
...
export var ListeConge = function (props) {
    ...
    var fetchItems = React.useCallback(function (force) {
        ...
        loadConges(siteUrl, force)
            ...
            .catch(function () { setError('Impossible de charger les demandes de congé.'); setLoading(false); });
    }, [siteUrl]);
    ...
    return (React.createElement("main", { className: "pt-6 sm:pt-8 pb-14 min-h-screen bg-slate-100 text-slate-800" },
        ...
        deleteItem ? (React.createElement(ConfirmDelete, { title: "Supprimer la demande", message: "Voulez-vous vraiment supprimer la demande de cong\u00E9 \u00AB ".concat(deleteItem.titre, " \u00BB de ").concat(deleteItem.demandeur, " ? Cette action est irr\u00E9versible."), onConfirm: handleConfirmDelete, onCancel: function () { return !deleting && setDeleteItem(null); } })) : null));
};
