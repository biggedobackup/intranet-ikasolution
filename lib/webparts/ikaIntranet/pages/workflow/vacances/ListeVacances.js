...
import { loadVacances, deleteVacance, formatDateFR } from '../../../services/workflow/vacances/index';
...
export var ListeVacances = function (props) {
        ...
        React.createElement("div", { className: "mx-auto max-w-[1650px] px-4 sm:px-6 lg:px-8 space-y-4" },
            ...
            loading ? (React.createElement("div", { className: "bg-white rounded-2xl p-10 shadow-sm border border-slate-200 text-center" },
                ...
                React.createElement("div", { className: "px-4" },
                    React.createElement(Pagination, { total: filtered.length, page: safePage, pageSize: pageSize, labelSingular: "demande", labelPlural: "demandes", onPageChange: setPage }))))),
        deleteItem ? (React.createElement(ConfirmDelete, { title: "Supprimer la demande", message: "Voulez-vous vraiment supprimer la demande de vacances \u00AB ".concat(deleteItem.titre, " \u00BB de ").concat(deleteItem.demandeur, " ? Cette action est irr\u00E9versible."), onConfirm: handleConfirmDelete, onCancel: function () { return !deleting && setDeleteItem(null); } })) : null));
};
