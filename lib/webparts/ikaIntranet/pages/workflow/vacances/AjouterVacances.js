...
import { FaArrowLeft, FaCalendarDays, FaUser, FaUserCheck, FaPaperPlane, FaRotate, FaCircleCheck, FaLocationDot } from 'react-icons/fa6';
import { VACANCES, VACANCE_VALIDATEURS } from '../../../services/workflow/vacances/data';
export var AjouterVacances = function (props) {
    var mode = props.mode, id = props.id;
    var existing = (mode === 'modifier' && id) ? VACANCES.find(function (i) { return i.id === id; }) : undefined;
    ...
    var _c = React.useState((existing === null || existing === void 0 ? void 0 : existing.destination) || ''), destination = _c[0], setDestination = _c[1];
    ...
    var _h = React.useState((existing === null || existing === void 0 ? void 0 : existing.validateur) || VACANCE_VALIDATEURS[0]), validateur = _h[0], setValidateur = _h[1];
            ...
            React.createElement("div", { className: "mx-auto max-w-2xl px-4 sm:px-6 lg:px-8" },
                React.createElement("div", { className: "bg-white rounded-2xl p-10 shadow-sm border border-slate-200 text-center" },
                    ...
                    React.createElement("div", { className: "mt-6 flex flex-col sm:flex-row items-center justify-center gap-3" },
                        React.createElement("a", { href: "#page-workflow-liste-vacances", className: "inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-ikaBlue text-white font-bold text-xs hover:bg-blue-600 shadow transition" },
                            React.createElement(FaArrowLeft, null),
                            " Retour \u00E0 la liste"),
                        React.createElement("a", { href: "#page-workflow-ajouter-vacances", className: "inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl border border-slate-200 bg-white text-slate-700 font-bold text-xs hover:bg-slate-50 transition" }, "Nouvelle demande"))))));
    }
    return (React.createElement("main", { className: "pt-6 sm:pt-8 pb-14 min-h-screen bg-slate-100 text-slate-800" },
        React.createElement("div", { className: "mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 space-y-4" },
            React.createElement("nav", { className: "flex items-center gap-2 text-[11px] font-semibold text-slate-500 flex-wrap" },
                ...
                React.createElement("span", null, "/"),
                React.createElement("span", { className: "text-ikaBlue" }, isEdit ? "Modifier : ".concat((existing === null || existing === void 0 ? void 0 : existing.titre) || '') : 'Nouvelle demande de vacances')),
                ...
                React.createElement("form", { onSubmit: handleSubmit, className: "p-6 sm:p-8 space-y-5" },
                    ...
                    React.createElement("div", null,
                        React.createElement("label", { className: "block text-xs font-bold text-slate-700 mb-1.5 flex items-center gap-1.5" },
                            ...
                            " Validateur"),
                        React.createElement("select", { value: validateur, onChange: function (e) { return setValidateur(e.target.value); }, className: inputCls }, VACANCE_VALIDATEURS.map(function (v) { return React.createElement("option", { key: v, value: v }, v); }))),
                    React.createElement("div", null,
                        React.createElement("label", { className: "block text-xs font-bold text-slate-700 mb-1.5 flex items-center gap-1.5" },
                            React.createElement(FaLocationDot, { className: "text-ikaBlue text-[10px]" }),
                            " Destination"),
                        React.createElement("input", { type: "text", value: destination, onChange: function (e) { return setDestination(e.target.value); }, required: true, placeholder: "Lieu de vacances", className: inputCls })),
                    ...
                    React.createElement("div", { className: "pt-2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3" },
                        ...
                        React.createElement("a", { href: isEdit ? "#page-workflow-modifier-vacances&id=".concat(id) : '#page-workflow-ajouter-vacances', onClick: function (e) { e.preventDefault(); setTitre((existing === null || existing === void 0 ? void 0 : existing.titre) || ''); setDemandeur((existing === null || existing === void 0 ? void 0 : existing.demandeur) || ''); setDestination((existing === null || existing === void 0 ? void 0 : existing.destination) || ''); setDateDebut((existing === null || existing === void 0 ? void 0 : existing.dateDebut) || ''); setDateFin((existing === null || existing === void 0 ? void 0 : existing.dateFin) || ''); setJours(existing ? String(existing.jours) : ''); setMotif((existing === null || existing === void 0 ? void 0 : existing.motif) || ''); setValidateur((existing === null || existing === void 0 ? void 0 : existing.validateur) || VACANCE_VALIDATEURS[0]); }, className: "inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl border border-slate-200 bg-white text-slate-700 font-bold text-xs hover:bg-slate-50 transition" },
...
export default AjouterVacances;
