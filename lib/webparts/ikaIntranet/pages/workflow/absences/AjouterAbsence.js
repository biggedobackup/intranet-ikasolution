...
import { ABSENCES, ABSENCE_VALIDATEURS } from '../../../services/workflow/absences/data';
...
export var AjouterAbsence = function (props) {
    ...
    var existing = (mode === 'modifier' && id) ? ABSENCES.find(function (i) { return i.id === id; }) : undefined;
    ...
    var _g = React.useState((existing === null || existing === void 0 ? void 0 : existing.validateur) || ABSENCE_VALIDATEURS[0]), validateur = _g[0], setValidateur = _g[1];
                ...
                React.createElement("form", { onSubmit: handleSubmit, className: "p-6 sm:p-8 space-y-5" },
                    ...
                    React.createElement("div", null,
                        React.createElement("label", { className: "block text-xs font-bold text-slate-700 mb-1.5 flex items-center gap-1.5" },
                            ...
                            " Validateur"),
                        React.createElement("select", { value: validateur, onChange: function (e) { return setValidateur(e.target.value); }, className: inputCls }, ABSENCE_VALIDATEURS.map(function (v) { return React.createElement("option", { key: v, value: v }, v); }))),
                    React.createElement("div", null,
