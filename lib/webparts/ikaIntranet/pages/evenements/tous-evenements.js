...
export var TousEvenements = function () {
    var _a = React.useState(''), search = _a[0], setSearch = _a[1];
    var _b = React.useState('all'), category = _b[0], setCategory = _b[1];
    var categories = __spreadArray(['all'], Array.from(new Set(EVENEMENTS.map(function (e) { return e.category; }))), true);
        ...
        React.createElement("div", { className: "mx-auto max-w-[1650px] px-4 sm:px-6 lg:px-8 space-y-4" },
            ...
            filtered.length === 0 ? (React.createElement("div", { className: "bg-white rounded-2xl p-10 shadow-sm border border-slate-200 text-center" },
                ...
                React.createElement("div", { className: "relative h-44 overflow-hidden" },
                    React.createElement("img", { src: e.img, alt: e.title, className: "w-full h-full object-cover group-hover:scale-105 transition duration-500" }),
                ...
                React.createElement("div", { className: "p-4" },
                    ...
                    React.createElement("div", { className: "flex flex-wrap items-center gap-x-3 gap-y-1 mt-2 text-[11px] font-semibold text-slate-500" },
                        React.createElement("span", { className: "flex items-center gap-1.5" },
                            React.createElement(FaCalendarDays, { className: e.dateIcon }),
                            " ",
                            e.date),
                        React.createElement("span", { className: "flex items-center gap-1.5" },
                            React.createElement(FaLocationDot, { className: e.locationIcon }),
                            " ",
                            e.location)),
