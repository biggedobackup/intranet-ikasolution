...
import { FaCalendarDays, FaLocationDot, FaArrowLeft, FaArrowRight, FaUser, FaChair, FaTag, FaRegCalendarPlus, FaCircleCheck, FaComment, FaPaperPlane, FaXmark } from 'react-icons/fa6';
import { loadEvenements, updateEvenementLikedBy, updateEvenementComments } from '../../services/evenements/index';
...
export var DetailEvenement = function (_a) {
    ...
    var toggleJoin = function () { return __awaiter(void 0, void 0, void 0, function () {
        var newLikedBy;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, updateEvenementLikedBy(siteUrl, event.id, newLikedBy)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, updateEvenementComments(siteUrl, event.id, newComments)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
                    ...
                    React.createElement("div", { className: "p-5 sm:p-8" },
                        ...
                        React.createElement("div", { className: "mt-6 flex items-center gap-2" },
                            React.createElement("button", { onClick: toggleJoin, className: "px-4 py-2 rounded-full border font-bold text-xs transition flex items-center gap-1.5 ".concat(isJoined ? 'bg-emerald-500 text-white border-emerald-500 shadow-sm' : 'border-emerald-200 bg-emerald-50 text-emerald-700 hover:bg-emerald-100') },
                                React.createElement(FaCircleCheck, { className: isJoined ? '' : 'text-xs' }),
                                " Je participe (",
                                likedBy.length,
                                ")"),
            ...
            React.createElement("div", { className: "bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl border border-slate-200 space-y-4 relative" },
                ...
                React.createElement("div", { className: "flex items-center gap-3" },
                    React.createElement("span", { className: "w-12 h-12 rounded-full bg-ikaBlue bg-opacity-10 text-ikaBlue flex items-center justify-center text-base" },
                        React.createElement(FaCalendarDays, null)),
