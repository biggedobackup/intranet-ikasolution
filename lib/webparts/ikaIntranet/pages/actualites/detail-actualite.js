...
import { FaClock, FaArrowLeft, FaArrowRight, FaUser, FaTag, FaNewspaper, FaHeart, FaComment, FaPaperPlane, FaXmark } from 'react-icons/fa6';
import { loadActualites, updateActualiteLikedBy, updateActualiteComments } from '../../services/actualites/index';
...
export var DetailActualite = function (_a) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, updateActualiteLikedBy(siteUrl, actualite.id, newLikedBy)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, updateActualiteComments(siteUrl, actualite.id, newComments)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
            ...
            React.createElement("div", { className: "bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl border border-slate-200 space-y-4 relative" },
                ...
                React.createElement("div", { className: "flex items-center gap-3" },
                    React.createElement("span", { className: "w-12 h-12 rounded-full bg-ikaRed bg-opacity-10 text-ikaRed flex items-center justify-center text-base" },
                        React.createElement(FaNewspaper, null)),
