...
import { FaCubes, FaCloud, FaChartLine, FaMobileScreenButton, FaHeadset, FaGraduationCap, FaArrowLeft, FaArrowRight, FaCircleCheck, FaTag, FaLayerGroup } from 'react-icons/fa6';
...
var produitIcon = function (name) {
    switch (name) {
        case 'cubes': return React.createElement(FaCubes, null);
        case 'cloud': return React.createElement(FaCloud, null);
        case 'chart-line': return React.createElement(FaChartLine, null);
        case 'mobile-screen-button': return React.createElement(FaMobileScreenButton, null);
        case 'headset': return React.createElement(FaHeadset, null);
        case 'graduation-cap': return React.createElement(FaGraduationCap, null);
        default: return React.createElement(FaCubes, null);
    }
};
export var DetailProduit = function () {
                ...
                React.createElement("aside", { className: "space-y-4" },
                    React.createElement("div", { className: "bg-white rounded-2xl p-5 shadow-sm border border-slate-200" },
                        React.createElement("h2", { className: "text-xs font-black uppercase tracking-wider text-slate-900 pb-3 border-b border-slate-100 mb-4 flex items-center gap-1.5" },
                            React.createElement(FaLayerGroup, { className: "text-ikaBlue text-[11px]" }),
                            " Autres services"),
