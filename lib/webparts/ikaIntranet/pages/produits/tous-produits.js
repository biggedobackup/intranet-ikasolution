...
import { FaCubes, FaCloud, FaChartLine, FaMobileScreenButton, FaHeadset, FaGraduationCap, FaMagnifyingGlass } from 'react-icons/fa6';
...
export var TousProduits = function () {
    var _a = React.useState(''), search = _a[0], setSearch = _a[1];
    var _b = React.useState('all'), category = _b[0], setCategory = _b[1];
    var categories = __spreadArray(['all'], Array.from(new Set(PRODUITS.map(function (p) { return p.category; }))), true);
