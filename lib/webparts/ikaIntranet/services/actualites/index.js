...
export function loadActualites(siteUrl) {
    return __awaiter(this, void 0, void 0, function () {
                ...
                case 7:
                    ...
                    actualites_1 = items
                        ...
                        return {
                            ...
                            likedBy: parseLikedBy(getVal(it, fieldMapFinal_1, 'AimerPar', ['AimerPar'])),
...
export function updateActualiteLikedBy(siteUrl, itemId, likedBy) {
    return __awaiter(this, void 0, void 0, function () {
        var listName;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function updateActualiteComments(siteUrl, itemId, comments) {
    return __awaiter(this, void 0, void 0, function () {
        var listName;
        return __generator(this, function (_a) {
            switch (_a.label) {
