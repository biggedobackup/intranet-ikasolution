...
export function loadEmployesMois(siteUrl) {
    return __awaiter(this, void 0, void 0, function () {
                ...
                case 7:
                    ...
                    employes_1 = items
                        ...
                        return {
                            ...
                            likedBy: parseLikedBy(getVal(it, fieldMapFinal_1, 'AimerPar', ['AimerPar', 'AimePar'])),
                            comments: parseComments(getVal(it, fieldMapFinal_1, 'CommenterPar', ['CommenterPar']))
                        };
                    })
...
export function updateEmployeMoisLikedBy(siteUrl, itemId, likedBy) {
    return __awaiter(this, void 0, void 0, function () {
        var listName;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    listName = _a.sent();
                    return [2 /*return*/, patchField(siteUrl, listName, itemId, 'AimerPar', likedBy)];
            }
        });
    });
}
export function updateEmployeMoisComments(siteUrl, itemId, comments) {
    return __awaiter(this, void 0, void 0, function () {
        var listName;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    listName = _a.sent();
                    return [2 /*return*/, patchField(siteUrl, listName, itemId, 'CommenterPar', comments)];
            }
        });
    });
}
