...
export var ABSENCE_TYPES = ['Maladie', 'Autorisée', 'Imprévue', 'Rendez-vous'];
export var ABSENCE_STATUTS = ['En attente', 'Approuvé', 'Refusé', 'Annulé'];
...
function mapItem(it, keys) {
    ...
    return {
        ...
        type: asString(getVal(it, keys.fieldMap, 'Type Absence', ['TypeAbsence'])),
...
export function loadAbsences(siteUrl, force) {
    return __awaiter(this, void 0, void 0, function () {
...
export function loadAbsence(siteUrl, id) {
    return __awaiter(this, void 0, void 0, function () {
...
export function createAbsence(siteUrl, payload) {
    return __awaiter(this, void 0, void 0, function () {
            ...
            switch (_b.label) {
                ...
                case 5:
                    ...
                    if (id && payload.validateurEmail) {
                        link = "".concat(getAppPageUrl(), "#page-workflow-detail-absence&id=").concat(id);
                        subject = "Nouveau signalement d'absence \u00E0 valider : ".concat(payload.titre);
                        body = "<p>Bonjour,</p>\n<p><strong>".concat(escapeHtml(currentUser.title), "</strong> a soumis un nouveau signalement d'absence : <strong>").concat(escapeHtml(payload.titre), "</strong>.</p>\n<p>Type : ").concat(escapeHtml(payload.type), "<br/>P\u00E9riode : du ").concat(formatDateFR(payload.dateDebut), " au ").concat(formatDateFR(payload.dateFin), " (").concat(payload.jours, " jour(s))</p>\n<p>Motif : ").concat(escapeHtml(payload.motif), "</p>\n<p><a href=\"").concat(link, "\">Consulter et traiter le signalement</a></p>");
...
export function updateAbsence(siteUrl, id, payload) {
    return __awaiter(this, void 0, void 0, function () {
...
export function deleteAbsence(siteUrl, id) {
    return __awaiter(this, void 0, void 0, function () {
        var ok;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function loadAbsenceAttachment(siteUrl, id) {
    return __awaiter(this, void 0, void 0, function () {
        var files;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function uploadAbsenceAttachment(siteUrl, id, file) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
export function removeAbsenceAttachment(siteUrl, id, fileName) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
export function applyAbsenceDecision(siteUrl, absence, action, comment, date) {
    return __awaiter(this, void 0, void 0, function () {
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    fields = (_a = {},
                        ...
                        _a);
                    return [4 /*yield*/, updateListItemFields(siteUrl, LIST_NAME, absence.id, fields)];
                case 2:
                    ok = _b.sent();
                    if (ok) {
                        invalidateCache();
                        if (absence.demandeurEmail) {
                            ...
                            link = "".concat(getAppPageUrl(), "#page-workflow-detail-absence&id=").concat(absence.id);
                            subject = approved ? "Votre signalement d'absence a \u00E9t\u00E9 approuv\u00E9" : "Votre signalement d'absence a \u00E9t\u00E9 refus\u00E9";
                            body = "<p>Bonjour ".concat(escapeHtml(absence.demandeur), ",</p>\n<p>Votre signalement d'absence <strong>").concat(escapeHtml(absence.titre), "</strong> a \u00E9t\u00E9 ").concat(approved ? 'approuvé' : 'refusé', ".</p>\n").concat(comment ? "<p>Commentaire : ".concat(escapeHtml(comment), "</p>") : '', "\n<p><a href=\"").concat(link, "\">Voir le signalement</a></p>");
                            sendEmail(siteUrl, [absence.demandeurEmail], subject, body).catch(function () { return undefined; });
                        }
                    }
                    return [2 /*return*/, ok];
                case 3:
