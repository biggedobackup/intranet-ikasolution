...
export var CONGE_TYPES = ['Congé annuel', 'Congé exceptionnel', 'Congé de maladie', 'Congé de maternité', 'Congé de paternité'];
export var CONGE_STATUTS = ['En attente', 'Approuvé', 'Refusé', 'Annulé'];
...
function mapItem(it, keys) {
    ...
    return {
        ...
        type: asString(getVal(it, keys.fieldMap, 'Type Congé', ['TypeConge'])),
...
export function loadConges(siteUrl, force) {
    return __awaiter(this, void 0, void 0, function () {
...
export function loadConge(siteUrl, id) {
    return __awaiter(this, void 0, void 0, function () {
...
export function createConge(siteUrl, payload) {
    return __awaiter(this, void 0, void 0, function () {
...
export function updateConge(siteUrl, id, payload) {
    return __awaiter(this, void 0, void 0, function () {
...
export function deleteConge(siteUrl, id) {
    return __awaiter(this, void 0, void 0, function () {
        var ok;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function loadCongeAttachment(siteUrl, id) {
    return __awaiter(this, void 0, void 0, function () {
        var files;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function uploadCongeAttachment(siteUrl, id, file) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
export function removeCongeAttachment(siteUrl, id, fileName) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
export function applyCongeDecision(siteUrl, conge, action, comment, date) {
    return __awaiter(this, void 0, void 0, function () {
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    fields = (_a = {},
                        ...
                        _a);
                    return [4 /*yield*/, updateListItemFields(siteUrl, LIST_NAME, conge.id, fields)];
                case 2:
                    ok = _b.sent();
                    if (ok) {
                        invalidateCache();
                        if (conge.demandeurEmail) {
                            ...
                            link = "".concat(getAppPageUrl(), "#page-workflow-detail-conge&id=").concat(conge.id);
                            subject = approved ? "Votre demande de cong\u00E9 a \u00E9t\u00E9 approuv\u00E9e" : "Votre demande de cong\u00E9 a \u00E9t\u00E9 refus\u00E9e";
                            body = "<p>Bonjour ".concat(escapeHtml(conge.demandeur), ",</p>\n<p>Votre demande de cong\u00E9 <strong>").concat(escapeHtml(conge.titre), "</strong> a \u00E9t\u00E9 ").concat(approved ? 'approuvée' : 'refusée', ".</p>\n").concat(comment ? "<p>Commentaire : ".concat(escapeHtml(comment), "</p>") : '', "\n<p><a href=\"").concat(link, "\">Voir la demande</a></p>");
                            sendEmail(siteUrl, [conge.demandeurEmail], subject, body).catch(function () { return undefined; });
                        }
                    }
                    return [2 /*return*/, ok];
                case 3:
