...
export var BESOIN_PRIORITES = ['Basse', 'Moyenne', 'Haute'];
export var BESOIN_STATUTS = ['En attente', 'Approuvé', 'Refusé', 'Annulé'];
...
function mapItem(it, keys) {
    ...
    return {
        ...
        priorite: (asString(getVal(it, keys.fieldMap, 'Priorité', ['Priorite'])) || 'Moyenne'),
...
export function loadBesoins(siteUrl, force) {
    return __awaiter(this, void 0, void 0, function () {
...
export function loadBesoin(siteUrl, id) {
    return __awaiter(this, void 0, void 0, function () {
...
export function createBesoin(siteUrl, payload) {
    return __awaiter(this, void 0, void 0, function () {
            ...
            switch (_b.label) {
                ...
                case 5:
                    ...
                    if (id && payload.validateurEmail) {
                        link = "".concat(getAppPageUrl(), "#page-workflow-detail-besoin&id=").concat(id);
                        subject = "Nouvelle expression de besoin \u00E0 valider : ".concat(payload.titre);
                        body = "<p>Bonjour,</p>\n<p><strong>".concat(escapeHtml(currentUser.title), "</strong> a soumis une nouvelle expression de besoin : <strong>").concat(escapeHtml(payload.titre), "</strong>.</p>\n<p>Priorit\u00E9 : ").concat(escapeHtml(payload.priorite), "<br/>Date souhait\u00E9e : ").concat(formatDateFR(payload.dateSouhaitee), "</p>\n<p>Description : ").concat(escapeHtml(payload.description), "</p>\n<p><a href=\"").concat(link, "\">Consulter et traiter la demande</a></p>");
...
export function updateBesoin(siteUrl, id, payload) {
    return __awaiter(this, void 0, void 0, function () {
...
export function deleteBesoin(siteUrl, id) {
    return __awaiter(this, void 0, void 0, function () {
        var ok;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function loadBesoinAttachment(siteUrl, id) {
    return __awaiter(this, void 0, void 0, function () {
        var files;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
export function uploadBesoinAttachment(siteUrl, id, file) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
export function removeBesoinAttachment(siteUrl, id, fileName) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
...
export function applyBesoinDecision(siteUrl, besoin, action, comment, date) {
    return __awaiter(this, void 0, void 0, function () {
            ...
            switch (_b.label) {
                ...
                case 1:
                    ...
                    fields = (_a = {},
                        ...
                        _a);
                    return [4 /*yield*/, updateListItemFields(siteUrl, LIST_NAME, besoin.id, fields)];
                case 2:
                    ok = _b.sent();
                    if (ok) {
                        invalidateCache();
                        if (besoin.demandeurEmail) {
                            ...
                            link = "".concat(getAppPageUrl(), "#page-workflow-detail-besoin&id=").concat(besoin.id);
                            subject = approved ? "Votre expression de besoin a \u00E9t\u00E9 approuv\u00E9e" : "Votre expression de besoin a \u00E9t\u00E9 refus\u00E9e";
                            body = "<p>Bonjour ".concat(escapeHtml(besoin.demandeur), ",</p>\n<p>Votre expression de besoin <strong>").concat(escapeHtml(besoin.titre), "</strong> a \u00E9t\u00E9 ").concat(approved ? 'approuvée' : 'refusée', ".</p>\n").concat(comment ? "<p>Commentaire : ".concat(escapeHtml(comment), "</p>") : '', "\n<p><a href=\"").concat(link, "\">Voir la demande</a></p>");
                            sendEmail(siteUrl, [besoin.demandeurEmail], subject, body).catch(function () { return undefined; });
                        }
                    }
                    return [2 /*return*/, ok];
                case 3:
