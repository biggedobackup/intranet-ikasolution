    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("footer", { className: "border-t border-slate-200 bg-slate-900 text-white mt-auto" },
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "mx-auto grid max-w-[1650px] gap-10 px-4 py-12 sm:px-6 md:grid-cols-2 lg:grid-cols-4 lg:px-8" },
            ...
            columns.map(function (col) { return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { key: col.Category },
                ...
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "mt-4 grid gap-2 text-xs font-semibold text-slate-300" }, col.links.map(function (link) { return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("a", { key: link.Title, className: "hover:text-ikaBlue transition", href: link.URL }, link.Title)); })))); }),
            react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", null,
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("h3", { className: "text-xs font-black uppercase tracking-[0.18em] text-white" }, "Support & Assistance"),
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "mt-4 grid gap-3 text-xs font-semibold text-slate-300" },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", { className: "text-slate-400" }, "Ouagadougou, Burkina Faso"),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("a", { className: "hover:text-ikaBlue transition flex items-center gap-2", href: "tel:+22672089090" },
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: "w-4 h-4 text-emerald-400 flex items-center justify-center" },
                            react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_icons_fa6__WEBPACK_IMPORTED_MODULE_1__.FaPhone, null)),
                        "+226 72 08 90 90"),
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("a", { className: "hover:text-ikaBlue transition flex items-center gap-2", href: "mailto:support@ikasolution.bf" },
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", { className: "w-4 h-4 text-ikaBlue flex items-center justify-center" },
                            react__WEBPACK_IMPORTED_MODULE_0__.createElement(react_icons_fa6__WEBPACK_IMPORTED_MODULE_1__.FaEnvelope, null)),
                        "support@ikasolution.bf")))),
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("ab5de953b1a6e3dadce2")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=ika-intranet-web-part.3e0d2eaa7e7b7ec4da23.hot-update.js.map